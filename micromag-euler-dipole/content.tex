...
\begin{table}[tb!]
  \begin{center}
    \small
    \input{micromag-euler-dipole/simple-synthetic-results.tex}
  \end{center}
  \caption{
...
as well as supplemental figures and Jupyter notebooks, are available from
\citet{sourcearchive-micromag-euler-dipole}, which can also be found on
\url{https://github.com/\GitHubRepository} under the MIT and CC-BY licenses.
