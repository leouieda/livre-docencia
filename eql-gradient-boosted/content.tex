...
\begin{figure}[tb!]
    \centering
    \includegraphics[width=0.5\linewidth]{eql-gradient-boosted/figs/target-grid.pdf}
    \caption{
...
\begin{figure}[tb!]
    \centering
    \includegraphics[width=0.5\linewidth]{eql-gradient-boosted/figs/eql-boost-airborne.pdf}
    \caption{
...
\begin{figure}[tb!]
    \centering
    \includegraphics[width=0.5\linewidth]{eql-gradient-boosted/figs/australia-memory-cv-error.pdf}
    \makeatother
    \caption{
...
\begin{figure}[tb!]
    \centering
    \includegraphics[width=0.5\linewidth]{eql-gradient-boosted/figs/australia-residuals.png}
    \caption{
